...
LOG_PREFIX = "[V-Key Collector]"
VENDOR = "vkey"
PRODUCT = "vos"  # Ingests to dataset: vkey_vos_raw
...
class VKeyClient(BaseClient):
    ...
    def __init__(self, base_url: str, subscription_key: str, verify: bool = True, proxy: bool = False):
        headers = {
            ...
            'User-Agent': 'VKey-Cortex-XSIAM-Collector/1.0',
...
def main():
    ...
    try:
        ...
        elif command in ('vkey-get-events', 'vkey-get-threats'):
