...
class VKeyClient(BaseClient):
    ...
    def fetch_all_table_records(self, table_name: str, time_window_minute: int, page_size: int = 1000, max_records: int = 5000) -> List[Dict[str, Any]]:
        ...
        while len(records) < max_records:
            ...
            # Stop if last page reached or no new records
...
def fetch_incidents(
    ...
    # Format events into Cortex XSIAM incident/dataset records
    incidents = []
    new_seen_ids = []
    ...
    # Maintain sliding window of the last 2000 seen IDs for deduplication
